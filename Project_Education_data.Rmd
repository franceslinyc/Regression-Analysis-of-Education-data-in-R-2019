...
```{r}
# Load data 
ScoreData <- read.csv("https://raw.githubusercontent.com/franceslinyc/Regression-Analysis-of-Education-data-in-R-2019/master/scores.csv")
str(ScoreData)
#View(ScoreData)
```
